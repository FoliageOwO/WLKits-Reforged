package ml.windleaf.wlkitsreforged.modules.categories.manage.macro.macros.player

import ml.windleaf.wlkitsreforged.utils.PlayerParser
...
class PlayerManageMacro : MacroEntire<Unit> {
    private var player: PlayerParser? = null
