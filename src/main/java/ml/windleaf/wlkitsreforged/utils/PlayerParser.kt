...
/**
 * The PlayerParser class is for parse the player easily
 */
class PlayerParser(val type: TypeEnum, val player: ServerOperator, val playerType: PlayerType, val value: String = "") {
    /**
